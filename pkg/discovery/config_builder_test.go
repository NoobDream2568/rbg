...
roles:
  prefill:
    ...
    - address: test-cluster-prefill-0.s-test-cluster-prefill
      components:
        leader-0: test-cluster-prefill-0-leader-0.s-test-cluster-prefill
        worker-0: test-cluster-prefill-0-worker-0.s-test-cluster-prefill
        worker-1: test-cluster-prefill-0-worker-1.s-test-cluster-prefill
    - address: test-cluster-prefill-1.s-test-cluster-prefill
      components:
        leader-0: test-cluster-prefill-1-leader-0.s-test-cluster-prefill
        worker-0: test-cluster-prefill-1-worker-0.s-test-cluster-prefill
        worker-1: test-cluster-prefill-1-worker-1.s-test-cluster-prefill
    size: 2
`,
			wantErr: false,
		},
...
roles:
  prefill:
    ...
    - address: test-cluster-prefill-0.s-test-cluster-prefill
      components:
        leader-0: test-cluster-prefill-0-0.s-test-cluster-prefill
        worker-0: test-cluster-prefill-0-1.s-test-cluster-prefill
    size: 1
`,
			wantErr: false,
		},
...
roles:
  prefill:
    ...
    - address: test-cluster-prefill-0.s-test-cluster-prefill
      components:
        leader-0: test-cluster-prefill-0.s-test-cluster-prefill
        worker-0: test-cluster-prefill-1.s-test-cluster-prefill
    - address: test-cluster-prefill-1.s-test-cluster-prefill
      components:
        leader-0: test-cluster-prefill-2.s-test-cluster-prefill
        worker-0: test-cluster-prefill-3.s-test-cluster-prefill
    size: 2
`,
			wantErr: false,
		},
